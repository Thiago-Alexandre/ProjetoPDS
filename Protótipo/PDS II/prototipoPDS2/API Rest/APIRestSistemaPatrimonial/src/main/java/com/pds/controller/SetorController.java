...
public class SetorController {
    ...
    public ResponseEntity<SetorResponseDTO> salvar(@RequestBody @Valid SetorForSaveDTO dto) {
        Setor setor = setorService.salvar(dto.generationObject(), dto.getFilial(), dto.getResponsavel());
	...
	public ResponseEntity<SetorResponseDTO> alterar(@RequestBody @Valid SetorForUpdateDTO dto) {
		Setor setor = setorService.alterar(dto.generationObject(), dto.getResponsavel());
		if(setor.getId() != null) {
