...
public class UsuarioController {
	...
	public ResponseEntity<UsuarioResponseDTO> pesquisar(@RequestBody @Valid UsuarioLoginDTO dto) {
		UsuarioResponseDTO usuario = usuarioService.pesquisar(dto.getOrganizacao(), dto.getLogin(), dto.getSenha());
        if(usuario.getId() != null) {
