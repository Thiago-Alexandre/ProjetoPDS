...
/** 
 * DTO de Administrador a ser utilizado para salvar novo Administrador
...
public class AdministradorForSaveDTO {
	...
	public Administrador generationObject() {
		return new Administrador(nome, email, login, senha, bloqueado);
	}
}